...
//+++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
// Provider "MyCustomETWProvider" event count 1
//+++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++

// Provider GUID = 6a282996-820b-42f3-8725-573fd309cd0a
EXTERN_C __declspec(selectany) const GUID MY_ETW_PROVIDER = {0x6a282996, 0x820b, 0x42f3, {0x87, 0x25, 0x57, 0x3f, 0xd3, 0x09, 0xcd, 0x0a}};

#ifndef MY_ETW_PROVIDER_Traits
#define MY_ETW_PROVIDER_Traits NULL
#endif // MY_ETW_PROVIDER_Traits

//
// Channel
//
#define MY_ETW_PROVIDER_CHANNEL_MyCustomETWProvider_Operational 0x10
#define MY_ETW_PROVIDER_CHANNEL_MyCustomETWProvider_Operational_KEYWORD 0x8000000000000000

//
// Event Descriptors
//
EXTERN_C __declspec(selectany) const EVENT_DESCRIPTOR ProcessMessage = {0x539, 0x0, 0x10, 0x4, 0x0, 0x0, 0x8000000000000000};
#define ProcessMessage_value 0x539
...
//
EXTERN_C __declspec(selectany) DECLSPEC_CACHEALIGN ULONG MyCustomETWProviderEnableBits[1];
EXTERN_C __declspec(selectany) const ULONGLONG MyCustomETWProviderKeywords[1] = {0x8000000000000000};
EXTERN_C __declspec(selectany) const unsigned char MyCustomETWProviderLevels[1] = {4};

//
// Provider context
//
EXTERN_C __declspec(selectany) MCGEN_TRACE_CONTEXT MY_ETW_PROVIDER_Context = {0, (ULONG_PTR)MY_ETW_PROVIDER_Traits, 0, 0, 0, 0, 0, 0, 1, MyCustomETWProviderEnableBits, MyCustomETWProviderKeywords, MyCustomETWProviderLevels};

//
// Provider REGHANDLE
//
#define MyCustomETWProviderHandle (MY_ETW_PROVIDER_Context.RegistrationHandle)
...
//
#define MY_ETW_PROVIDER_EventWriteActivity 0
...
//
#ifndef EventRegisterMyCustomETWProvider
#define EventRegisterMyCustomETWProvider() McGenEventRegister(&MY_ETW_PROVIDER, McGenControlCallbackV2, &MY_ETW_PROVIDER_Context, &MyCustomETWProviderHandle)
#endif
...
//
#ifndef EventRegisterByGuidMyCustomETWProvider
#define EventRegisterByGuidMyCustomETWProvider(Guid) McGenEventRegister(&(Guid), McGenControlCallbackV2, &MY_ETW_PROVIDER_Context, &MyCustomETWProviderHandle)
#endif
...
//
#ifndef EventUnregisterMyCustomETWProvider
#define EventUnregisterMyCustomETWProvider() McGenEventUnregister(&MyCustomETWProviderHandle)
#endif
...
// - Caller allocates memory, e.g. pContext = malloc(sizeof(McGenContext_MyCustomETWProvider));
// - Caller registers the provider, e.g. EventRegisterMyCustomETWProvider_ForContext(pContext);
// - Caller writes events, e.g. EventWriteMyEvent_ForContext(pContext, ...);
// - Caller unregisters, e.g. EventUnregisterMyCustomETWProvider_ForContext(pContext);
// - Caller frees memory, e.g. free(pContext);
//

typedef struct tagMcGenContext_MyCustomETWProvider {
    // The fields of this structure are subject to change and should
    // not be accessed directly. To access the provider's REGHANDLE,
    // use MyCustomETWProviderHandle_ForContext(pContext).
    MCGEN_TRACE_CONTEXT Context;
    ULONG EnableBits[1];
} McGenContext_MyCustomETWProvider;

#define EventRegisterMyCustomETWProvider_ForContext(pContext)             _mcgen_PASTE2(_mcgen_RegisterForContext_MyCustomETWProvider_, MCGEN_EVENTREGISTER)(&MY_ETW_PROVIDER, pContext)
#define EventRegisterByGuidMyCustomETWProvider_ForContext(Guid, pContext) _mcgen_PASTE2(_mcgen_RegisterForContext_MyCustomETWProvider_, MCGEN_EVENTREGISTER)(&(Guid), pContext)
#define EventUnregisterMyCustomETWProvider_ForContext(pContext)           McGenEventUnregister(&(pContext)->Context.RegistrationHandle)

//
// Provider REGHANDLE for caller-allocated context.
//
#define MyCustomETWProviderHandle_ForContext(pContext) ((pContext)->Context.RegistrationHandle)

// This function is for use by MC-generated code and should not be used directly.
// Initialize and register the caller-allocated context.
__inline
ULONG __stdcall
_mcgen_PASTE2(_mcgen_RegisterForContext_MyCustomETWProvider_, MCGEN_EVENTREGISTER)(
    _In_ LPCGUID pProviderId,
    _Out_ McGenContext_MyCustomETWProvider* pContext)
{
    RtlZeroMemory(pContext, sizeof(*pContext));
    pContext->Context.Logger = (ULONG_PTR)MY_ETW_PROVIDER_Traits;
    pContext->Context.EnableBitsCount = 1;
    pContext->Context.EnableBitMask = pContext->EnableBits;
    pContext->Context.EnableKeyWords = MyCustomETWProviderKeywords;
    pContext->Context.EnableLevel = MyCustomETWProviderLevels;
...
FORCEINLINE
_Ret_ McGenContext_MyCustomETWProvider*
_mcgen_CheckContextType_MyCustomETWProvider(_In_ McGenContext_MyCustomETWProvider* pContext)
{
    return pContext;
}
...
//
// Enablement check macro for event "ProcessMessage"
//
#define EventEnabledProcessMessage() _mcgen_EVENT_BIT_SET(MyCustomETWProviderEnableBits, 0)
#define EventEnabledProcessMessage_ForContext(pContext) _mcgen_EVENT_BIT_SET(_mcgen_CheckContextType_MyCustomETWProvider(pContext)->EnableBits, 0)

//
// Event write macros for event "ProcessMessage"
//
#define EventWriteProcessMessage(PID, Message) \
        MCGEN_EVENT_ENABLED(ProcessMessage) \
        ? _mcgen_TEMPLATE_FOR_ProcessMessage(&MY_ETW_PROVIDER_Context, &ProcessMessage, PID, Message) : 0
#define EventWriteProcessMessage_AssumeEnabled(PID, Message) \
        _mcgen_TEMPLATE_FOR_ProcessMessage(&MY_ETW_PROVIDER_Context, &ProcessMessage, PID, Message)
#define EventWriteProcessMessage_ForContext(pContext, PID, Message) \
        MCGEN_EVENT_ENABLED_FORCONTEXT(pContext, ProcessMessage) \
        ? _mcgen_TEMPLATE_FOR_ProcessMessage(&(pContext)->Context, &ProcessMessage, PID, Message) : 0
#define EventWriteProcessMessage_ForContextAssumeEnabled(pContext, PID, Message) \
        _mcgen_TEMPLATE_FOR_ProcessMessage(&_mcgen_CheckContextType_MyCustomETWProvider(pContext)->Context, &ProcessMessage, PID, Message)

// This macro is for use by MC-generated code and should not be used directly.
#define _mcgen_TEMPLATE_FOR_ProcessMessage _mcgen_PASTE2(McTemplateU0qz_, MCGEN_EVENTWRITETRANSFER)
...
//
// Function for template "PidStringTemplate" (and possibly others).
// This function is for use by MC-generated code and should not be used directly.
//
...
ETW_INLINE
ULONG
_mcgen_PASTE2(McTemplateU0qz_, MCGEN_EVENTWRITETRANSFER)(
    _In_ PMCGEN_TRACE_CONTEXT Context,
    _In_ PCEVENT_DESCRIPTOR Descriptor,
...
#define MSG_Event1337                        0xB0000539L
